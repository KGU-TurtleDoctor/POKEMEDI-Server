...
public enum ErrorCode {
    ...
    /**419 TOKEN EXPIRED 토큰 만료 (사용자 정의 상태 코드)*/

    // 쿠키 만료, 사용할 수 없음
    COOKIE_IS_EXPIRED(false, 419, "쿠키가 만료되어 사용할 수 없습니다."),

    /**498 INVALID TOKEN (사용자 정의 상태 코드)*/

    // JWT 시그니처 에러, 토큰이 유효하지 않음
    INVALID_JWT_SIGNATURE(false, 498, "JWT 유효성 검사를 통과하지 못했습니다."),
